...
/**
 * BankGolomt form base class.
 *
 * @method BankGolomt getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseBankGolomtForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bank_golomt[%s]');
