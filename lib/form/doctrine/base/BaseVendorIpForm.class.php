...
/**
 * VendorIp form base class.
 *
 * @method VendorIp getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseVendorIpForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vendor_ip[%s]');
