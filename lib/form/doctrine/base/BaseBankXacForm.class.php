...
/**
 * BankXac form base class.
 *
 * @method BankXac getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseBankXacForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'order_sequence_no' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'order_sequence_no' => new sfValidatorInteger(array('required' => false)),
      'status'            => new sfValidatorInteger(array('required' => false)),
      'transfer_sap'      => new sfValidatorInteger(),
      'try_count'         => new sfValidatorInteger(array('required' => false)),
      'created_at'        => new sfValidatorDateTime(),
      'updated_at'        => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('bank_xac[%s]');
