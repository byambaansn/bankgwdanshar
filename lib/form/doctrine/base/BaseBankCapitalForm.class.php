...
/**
 * BankCapital form base class.
 *
 * @method BankCapital getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseBankCapitalForm extends BaseFormDoctrine
{
