...
/**
 * BankSavings form base class.
 *
 * @method BankSavings getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseBankSavingsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'bank_account_id' => new sfValidatorInteger(),
      ...
      'order_date'      => new sfValidatorDate(),
    ...
    $this->widgetSchema->setNameFormat('bank_savings[%s]');
