...
/**
 * BankKhaanLog form base class.
 *
 * @method BankKhaanLog getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseBankKhaanLogForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bank_khaan_log[%s]');
