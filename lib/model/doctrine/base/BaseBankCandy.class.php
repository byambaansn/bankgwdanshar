...
Doctrine_Manager::getInstance()->bindComponent('BankCandy', 'doctrine');
 ...
 * @method BankCandy setId()             Sets the current record's "id" value
 * @method BankCandy setVendorId()       Sets the current record's "vendor_id" value
 * @method BankCandy setChargeMobile()   Sets the current record's "charge_mobile" value
 * @method BankCandy setChargeAmount()   Sets the current record's "charge_amount" value
 * @method BankCandy setPercent()        Sets the current record's "percent" value
 * @method BankCandy setBankAccount()    Sets the current record's "bank_account" value
 * @method BankCandy setOrderId()        Sets the current record's "order_id" value
 * @method BankCandy setSalesOrderId()   Sets the current record's "sales_order_id" value
 * @method BankCandy setOrderP()         Sets the current record's "order_p" value
 * @method BankCandy setOrderMobile()    Sets the current record's "order_mobile" value
 * @method BankCandy setOrderDate()      Sets the current record's "order_date" value
 * @method BankCandy setOrderType()      Sets the current record's "order_type" value
 * @method BankCandy setOrderAmount()    Sets the current record's "order_amount" value
 * @method BankCandy setOrderChannel()   Sets the current record's "order_channel" value
 * @method BankCandy setOrderS()         Sets the current record's "order_s" value
 * @method BankCandy setStatus()         Sets the current record's "status" value
 * @method BankCandy setTryCount()       Sets the current record's "try_count" value
 * @method BankCandy setCreatedAt()      Sets the current record's "created_at" value
 * @method BankCandy setUpdatedAt()      Sets the current record's "updated_at" value
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseBankCandy extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('bank_candy');
