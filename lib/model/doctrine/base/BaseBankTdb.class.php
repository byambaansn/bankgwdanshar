...
Doctrine_Manager::getInstance()->bindComponent('BankTdb', 'doctrine');
 ...
 * @method integer   getOrderTeller()    Returns the current record's "order_teller" value
 ...
 * @method BankTdb   setId()             Sets the current record's "id" value
 * @method BankTdb   setVendorId()       Sets the current record's "vendor_id" value
 * @method BankTdb   setChargeMobile()   Sets the current record's "charge_mobile" value
 * @method BankTdb   setChargeAmount()   Sets the current record's "charge_amount" value
 * @method BankTdb   setPercent()        Sets the current record's "percent" value
 * @method BankTdb   setBankAccount()    Sets the current record's "bank_account" value
 * @method BankTdb   setOrderId()        Sets the current record's "order_id" value
 * @method BankTdb   setOrderIdSub()     Sets the current record's "order_id_sub" value
 * @method BankTdb   setSalesOrderId()   Sets the current record's "sales_order_id" value
 * @method BankTdb   setOrderP()         Sets the current record's "order_p" value
 * @method BankTdb   setOrderMobile()    Sets the current record's "order_mobile" value
 * @method BankTdb   setOrderDate()      Sets the current record's "order_date" value
 * @method BankTdb   setOrderType()      Sets the current record's "order_type" value
 * @method BankTdb   setOrderAmount()    Sets the current record's "order_amount" value
 * @method BankTdb   setOrderChannel()   Sets the current record's "order_channel" value
 * @method BankTdb   setOrderTeller()    Sets the current record's "order_teller" value
 * @method BankTdb   setOrderS()         Sets the current record's "order_s" value
 * @method BankTdb   setStatus()         Sets the current record's "status" value
 * @method BankTdb   setTransferSap()    Sets the current record's "transfer_sap" value
 * @method BankTdb   setTryCount()       Sets the current record's "try_count" value
 * @method BankTdb   setCreatedAt()      Sets the current record's "created_at" value
 * @method BankTdb   setUpdatedAt()      Sets the current record's "updated_at" value
 * @method BankTdb   setRelatedAccount() Sets the current record's "related_account" value
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseBankTdb extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('bank_tdb');
        ...
        $this->hasColumn('order_teller', 'integer', 4, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
