...
Doctrine_Manager::getInstance()->bindComponent('BankGolomt', 'doctrine');
 ...
 * @method BankGolomt setChargeAmount()   Sets the current record's "charge_amount" value
 * @method BankGolomt setPercent()        Sets the current record's "percent" value
 * @method BankGolomt setBankAccount()    Sets the current record's "bank_account" value
 * @method BankGolomt setOrderId()        Sets the current record's "order_id" value
 * @method BankGolomt setSalesOrderId()   Sets the current record's "sales_order_id" value
 * @method BankGolomt setOrderP()         Sets the current record's "order_p" value
 * @method BankGolomt setOrderMobile()    Sets the current record's "order_mobile" value
 * @method BankGolomt setOrderDate()      Sets the current record's "order_date" value
 * @method BankGolomt setOrderType()      Sets the current record's "order_type" value
 * @method BankGolomt setOrderAmount()    Sets the current record's "order_amount" value
 * @method BankGolomt setOrderChannel()   Sets the current record's "order_channel" value
 * @method BankGolomt setOrderS()         Sets the current record's "order_s" value
 * @method BankGolomt setStatus()         Sets the current record's "status" value
 * @method BankGolomt setTransferSap()    Sets the current record's "transfer_sap" value
 ...
 */
abstract class BaseBankGolomt extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('bank_golomt');
