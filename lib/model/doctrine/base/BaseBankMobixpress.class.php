...
Doctrine_Manager::getInstance()->bindComponent('BankMobixpress', 'doctrine');
 ...
 * @method BankMobixpress setId()             Sets the current record's "id" value
 * @method BankMobixpress setVendorId()       Sets the current record's "vendor_id" value
 * @method BankMobixpress setChargeMobile()   Sets the current record's "charge_mobile" value
 * @method BankMobixpress setChargeAmount()   Sets the current record's "charge_amount" value
 * @method BankMobixpress setPercent()        Sets the current record's "percent" value
 * @method BankMobixpress setBankAccount()    Sets the current record's "bank_account" value
 * @method BankMobixpress setOrderId()        Sets the current record's "order_id" value
 * @method BankMobixpress setSalesOrderId()   Sets the current record's "sales_order_id" value
 * @method BankMobixpress setOrderP()         Sets the current record's "order_p" value
 * @method BankMobixpress setOrderMobile()    Sets the current record's "order_mobile" value
 * @method BankMobixpress setOrderDate()      Sets the current record's "order_date" value
 * @method BankMobixpress setOrderType()      Sets the current record's "order_type" value
 * @method BankMobixpress setOrderAmount()    Sets the current record's "order_amount" value
 * @method BankMobixpress setOrderChannel()   Sets the current record's "order_channel" value
 * @method BankMobixpress setOrderS()         Sets the current record's "order_s" value
 * @method BankMobixpress setStatus()         Sets the current record's "status" value
 * @method BankMobixpress setTryCount()       Sets the current record's "try_count" value
 * @method BankMobixpress setCreatedAt()      Sets the current record's "created_at" value
 * @method BankMobixpress setUpdatedAt()      Sets the current record's "updated_at" value
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseBankMobixpress extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('bank_mobixpress');
        ...
        $this->hasColumn('order_channel', 'string', 250, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
