...
Doctrine_Manager::getInstance()->bindComponent('BankXac', 'doctrine');
 ...
 * @method BankXac   setChargeAmount()      Sets the current record's "charge_amount" value
 * @method BankXac   setPercent()           Sets the current record's "percent" value
 * @method BankXac   setBankAccount()       Sets the current record's "bank_account" value
 * @method BankXac   setOrderId()           Sets the current record's "order_id" value
 * @method BankXac   setSalesOrderId()      Sets the current record's "sales_order_id" value
 * @method BankXac   setOrderP()            Sets the current record's "order_p" value
 * @method BankXac   setOrderMobile()       Sets the current record's "order_mobile" value
 * @method BankXac   setOrderDate()         Sets the current record's "order_date" value
 * @method BankXac   setOrderType()         Sets the current record's "order_type" value
 * @method BankXac   setOrderAmount()       Sets the current record's "order_amount" value
 * @method BankXac   setOrderChannel()      Sets the current record's "order_channel" value
 * @method BankXac   setOrderS()            Sets the current record's "order_s" value
 * @method BankXac   setOrderSequenceNo()   Sets the current record's "order_sequence_no" value
 * @method BankXac   setStatus()            Sets the current record's "status" value
 * @method BankXac   setTransferSap()       Sets the current record's "transfer_sap" value
 ...
 */
abstract class BaseBankXac extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('bank_xac');
