<div id="recharge-div">
    <form id="form" method="POST" autocomplete="off" action="<?php echo url_for('@bankpayment_mobinet_prepaid_update'); ?>">
            ...
            <table class="table table-striped">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><input type="text" id="contract_number" name="contract_number" value=""  /></td>
                    </tr>
                    <tr>
