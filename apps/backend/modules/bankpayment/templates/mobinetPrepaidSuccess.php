...
<form id="form" action="<?php echo url_for('@bankpayment_mobinet_payment') ?>" method="POST" autocomplete="off">
    <table>
        <thead>
            <tr>
                ...
                <th  width="40" rowspan="2">Сун.Сар</th>
                <th  width="100" rowspan="2">Ажилтан</th>
                <th  width="40" rowspan="2">Төлөлтийн огноо</th>
                <th  width="80" rowspan="2">Огноо</th>
                <th  width="100" colspan="3">Үйлдэл</th>
            </tr>
            <tr>
                <th  width="50">Банк</th>
        ...
        <tbody>
            ...
            foreach ($rows as $row):
                ...
                <tr>
                    ...
                    <td align="center"><?php echo $row['bundle_name'] ?></td>
                    <td align="center"><?php echo $row['extent_month'] ?></td>
                    <td align="center"><?php echo $row['username'] ?></td>
                    <td align="center"><?php echo $row['updated_at'] ?></td>
                    <td align="left"><?php echo $row['created_at'] ?></td>
                    <td align="center">
                        <a  rel="facebox" href="<?php echo url_for('@bankpayment_mobinet_prepaid_update') . '?id=' . $row['id'] ?>"><img style="cursor: pointer" src="/images/icons/edit.png" alt="Засах" ></a>
                    </td>
