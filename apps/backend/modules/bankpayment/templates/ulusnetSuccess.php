<?php echo include_component('bankpayment', 'searchForm', array('status' => $status, 'type' => $type)); ?>
<form id="form" action="<?php echo url_for('@bankpayment_ulusnet_payment') ?>" method="POST" autocomplete="off">
    <table>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            foreach ($rows as $row):
                ...
                <tr>
                    ...
                    <td align="center">
                        <a  rel="facebox" href="<?php echo url_for('@bankpayment_ulusnet_update') . '?id=' . $row['id'] ?>"><img style="cursor: pointer" src="/images/icons/edit.png" alt="Засах" ></a>
                    </td>
                    <td align="center">
