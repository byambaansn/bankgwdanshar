...
<form id="form" action="<?php echo url_for('@bank_capitron_call_payment_list') ?>" autocomplete="off">
    <fieldset>
        <legend>ХАЙЛТ</legend>
        ...
        <a href="<?php echo url_for('@bank_capitron_call_payment_excel?' . $urlParams) ?>"><input type="button" value="Excel"/></a>
        <?php endif; ?>
    </fieldset>
</form>
    ...
    <tbody>
        <?php foreach ($pager->getResults() as $capitron): ?>
            ...
            <tr>
                ...
                <td align="center">
                    <?php echo link_to($status, '@bank_capitron_call_payment_status?id=' . $capitron->id, array('rel' => 'facebox')) ?>
...
<?php echo pager_navigation($pager, AppTools::getQueryString('@bank_capitron_call_payment_list')) ?>
